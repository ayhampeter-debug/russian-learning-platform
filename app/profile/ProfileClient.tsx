      ...
      <section className="mx-auto max-w-7xl px-4 pb-8 sm:px-6">
        <div className="mb-8 flex flex-col justify-between gap-5 md:flex-row md:items-center">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <Link
              href="/feedback"
              className="inline-flex w-full justify-center rounded-full border border-cyan-400/30 bg-cyan-400/10 px-6 py-3 font-bold text-cyan-100 transition hover:border-cyan-400/50 hover:bg-cyan-400/15 sm:w-fit"
            >
              {text.profile.sendFeedback}
            </Link>
            <Link
              href="/dashboard"
