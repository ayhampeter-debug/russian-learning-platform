...
export function Navigation() {
  ...
  return (
    <nav className="mx-auto mb-6 w-full max-w-7xl px-3 pt-4 sm:mb-10 sm:px-6 sm:pt-6">
      <div className="rounded-2xl border border-white/10 bg-white/10 p-2 shadow-2xl shadow-cyan-950/20 backdrop-blur sm:rounded-3xl sm:p-3">
        <div className="flex min-w-0 flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex min-w-0 items-center gap-2">
            <Link
              href="/"
              className="flex min-w-0 flex-1 items-center justify-between gap-3 rounded-2xl bg-slate-950/70 px-3 py-3 transition hover:bg-slate-900 sm:px-4 lg:flex-none"
            >
