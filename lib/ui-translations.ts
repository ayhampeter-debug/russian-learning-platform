...
export const uiText = {
  en: {
    ...
    home: {
      ...
      howTitle: "Choose a course, practice, then unlock the next challenge",
      howText:
      ...
      chooseWorldText: "Start with the Russian course now. More language courses are planned.",
      ...
      levelUp: "Earn XP and unlock worlds",
      levelUpText: "Build XP, save progress, and open new worlds as you advance.",
