...
export const uiText = {
  en: {
    ...
    lesson: {
      ...
      typeColorInRussian: "Type the color in Russian",
      color: "Color",
      correctColor: "Correct color",
      practiceColorsInWriting: "Practice colors in writing",
      headFace: "Head & Face",
      body: "Body",
  ...
  ar: {
    ...
    lesson: {
      ...
      matchTheColor: "طابق اللون",
      typeColorInRussian: "اكتب اللون بالروسية",
      color: "اللون",
      correctColor: "اللون الصحيح",
      practiceColorsInWriting: "تدرّب على كتابة الألوان",
