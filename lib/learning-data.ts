...
export const fruitsVegetablesLesson: Lesson = {
  id: "fruits-vegetables",
  number: "3",
  title: "Fruits and Vegetables",
  description: "Learn Russian fruit and vegetable words with sorting, matching, listening, and typing practice.",
  stageId: "basics",
  status: "Unlocked",
  xp: 140,
  xpReward: 140,
  locked: false,
  vocabulary: [
    { russian: "яблоко", english: "apple", arabic: "تفاحة" },
    { russian: "банан", english: "banana", arabic: "موز" },
    { russian: "апельсин", english: "orange", arabic: "برتقال" },
    { russian: "виноград", english: "grapes", arabic: "عنب" },
    { russian: "клубника", english: "strawberry", arabic: "فراولة" },
    { russian: "груша", english: "pear", arabic: "كمثرى / إجاص" },
    { russian: "лимон", english: "lemon", arabic: "ليمون" },
    { russian: "арбуз", english: "watermelon", arabic: "بطيخ" },
    { russian: "персик", english: "peach", arabic: "خوخ" },
    { russian: "вишня", english: "cherry", arabic: "كرز" },
    { russian: "ананас", english: "pineapple", arabic: "أناناس" },
    { russian: "манго", english: "mango", arabic: "مانجو" },
    { russian: "помидор", english: "tomato", arabic: "بندورة" },
    { russian: "огурец", english: "cucumber", arabic: "خيار" },
    { russian: "картофель", english: "potato", arabic: "بطاطا" },
    { russian: "морковь", english: "carrot", arabic: "جزر" },
    { russian: "лук", english: "onion", arabic: "بصل" },
    { russian: "капуста", english: "cabbage", arabic: "ملفوف" },
    { russian: "чеснок", english: "garlic", arabic: "ثوم" },
    { russian: "перец", english: "pepper", arabic: "فليفلة / فلفل" },
    { russian: "баклажан", english: "eggplant", arabic: "باذنجان" },
    { russian: "салат", english: "lettuce / salad", arabic: "خس / سلطة" },
    { russian: "горох", english: "peas", arabic: "بازلاء" },
    { russian: "кукуруза", english: "corn", arabic: "ذرة" },
  ],
  exercises: [
    {
      id: "fruits-vegetables-apple",
      type: "multipleChoice",
      prompt: "Choose the meaning.",
      display: "яблоко",
    ...
    {
      id: "fruits-vegetables-sort-fruit",
      type: "multipleChoice",
      prompt: "Choose the category.",
      display: "виноград",
      options: ["fruit", "vegetable"],
      correctAnswer: "fruit",
      explanation: "виноград is grapes, so it belongs with fruits.",
      points: 10,
    },
    {
      id: "fruits-vegetables-sort-vegetable",
      type: "multipleChoice",
      prompt: "Choose the category.",
      display: "морковь",
      options: ["fruit", "vegetable"],
      correctAnswer: "vegetable",
      explanation: "морковь is carrot, so it belongs with vegetables.",
      points: 10,
    },
    {
      id: "fruits-vegetables-match",
      type: "matching",
      prompt: "Match the produce words.",
      pairs: [
      ...
      englishOptions: ["potato", "banana", "cucumber", "lemon"],
      explanation: "These are useful everyday fruit and vegetable words.",
      points: 20,
    },
  ],
};
...
export const basicsWorld: World = {
  ...
  profileProgressPercent: 0,
  dashboardProgressPercent: 0,
  xp: bodyPartsLesson.xpReward + colorsLesson.xpReward + fruitsVegetablesLesson.xpReward,
  bossTitle: "",
  bossDescription: "",
  ...
  stages: [
    {
      ...
      number: "1",
      title: "Basics",
      description: "Start with Body Parts, then learn Colors, Fruits, and Vegetables.",
      status: "Unlocked",
      xp: bodyPartsLesson.xpReward + colorsLesson.xpReward + fruitsVegetablesLesson.xpReward,
    },
  ],
